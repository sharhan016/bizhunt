...
class AnimationSearchBar extends StatelessWidget {
  AnimationSearchBar({
    ...
    this.backIcon,
    this.duration,
    required this.focusNode, // Add FocusNode as a parameter
  }) : super(key: key);
  ...
  final FocusNode focusNode; // FocusNode to control the TextField's focus
                    ...
                    child: FittedBox(
                      child: KCustomButton(
                        ...
                        onPressed: () {
                          ...
                          focusNode.unfocus(); // Hide the keyboard
                        },
                      ),
                    ),
                  ),
